...
/*
    ...
    transporter.sendMail(mailOptions, function(err, info){
        if (err){
            ...
            user = null;
            res.json(null);   // mando el usuario en nulo, con lo cual no logea
        /*}
    });*/
  });
};
